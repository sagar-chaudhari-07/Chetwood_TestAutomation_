package automation.library.core;
...
import static automation.library.core.Locator.Loc;
import static automation.library.core.Locator.getLocator;
...
//    public Element findElementMobile(By by) {
//        Element el = new Element(driver, by);
//        return el.scroll();
//    }

    public Element findElementBy(By by) {
        Element el = new Element(driver, by);
        return el;
    }
    ...
    public HashMap<String, String> getBrokerUserCredentials(){
        HashMap<String,String> userCredentials = new HashMap<String,String>();
        String brokerUser = Property.getProperties(Constants.SELENIUMRUNTIMEPATH).getString("brokerUser");
        String brokerPwd = Property.getProperties(Constants.SELENIUMRUNTIMEPATH).getString("brokerPwd");
        userCredentials.put("user",brokerUser);
        userCredentials.put("pwd", brokerPwd);
        return userCredentials;
    }

    public String getTestAppUrl(){
        return Property.getProperties(Constants.SELENIUMRUNTIMEPATH).getString("testAppUrl");
    }
}
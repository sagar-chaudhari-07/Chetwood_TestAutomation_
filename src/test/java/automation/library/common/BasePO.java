...
import automation.library.core.PageObject;
...
public class BasePO extends PageObject {
    ...
    public static String stackTraceMsg = null;
    ...
    public String convertDoubleToString(String value){
    ...
    public String changeDateFormat(String date){
        ...
        String sep = "/";
        return dateArray[2]+sep+dateArray[1]+sep+dateArray[0];
    }

    public void mandatoryWait(long milliseconds){
        try {
